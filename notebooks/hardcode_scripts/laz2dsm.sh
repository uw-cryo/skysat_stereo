...
# Init projection is EPSG:326910, adjusted to NAVD88 Datum
...
# DEM posted at 2 m resolution, with 95 percentile stats filter for aggregrating points within the grid
#cmd
parallel --progress "point2dem --t_srs EPSG:32610 --tr 2 --filter 95-pct {}" ::: *first_return.laz
